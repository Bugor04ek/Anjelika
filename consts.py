...
main_table = PrettyTable(["IDZak", "Номер счета", "Марка", "Дата выпуска", "Длина кабеля, км", "Количество жил",
                          "После волочения, мм", "После мультика, мм", "Вид барабана", "Количество заправок",
                          "Километраж"])
